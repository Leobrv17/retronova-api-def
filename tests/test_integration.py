...
# import datetime
# from app.models import TicketOffer,PromoCode, Arcade, Game, ArcadeGame
...
#
#         # 1. Mock Firebase : assure qu’il est actif sur tout le test
...
#
#         # 3. Création d'une offre de tickets
#         offer = TicketOffer(
#             tickets_amount=1,
#             price_euros=2,
#             name="test offer"
...
#         db.commit()
#         db.refresh(offer)
#         mock_firebase.return_value = mock_firebase.return_value  # Réactivation du mock (important)
...
#         db.commit()
#
#         mock_firebase.return_value = mock_firebase.return_value
...
#
#         # 7. Vérifier le solde de tickets
#         balance_response = client.get("/api/v1/tickets/balance", headers=auth_headers)
#         assert balance_response.status_code == 200
#         balance = balance_response.json()["balance"]
#         expected_balance = offer.tickets_amount + promo.tickets_reward
#         assert balance == expected_balance
#
#         # 8. Créer une borne d’arcade et un jeu
#         arcade = Arcade(
...
#
#         # 11. Vérifier que les tickets ont été déduits
...
#
#         # 12. Vérifier la file d’attente de la borne
#         arcade_headers = {"X-API-Key": arcade.api_key}
#
#         print("arcade.api_key:", arcade.api_key)
#         print("headers:", arcade_headers)
#
