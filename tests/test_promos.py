...
class TestPromos:
    ...
    def test_get_promo_history_with_data(self, client, auth_headers_user, sample_user, sample_promo_code, db):
        ...
        assert data[0]["tickets_received"] == sample_promo_code.tickets_reward
    ...
    def test_get_promo_history_sorted_by_date(self, client, auth_headers_user, sample_user, db):
        ...
        # Vérifier que c'est trié par date décroissante (plus récent en premier)
        # Le dernier code utilisé devrait être en premier
